            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 ">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> {{ $caption ?? 'Tambah Data Alumni' }} </h4>
                                    ...
                                    <div class="col-12">
                                        <div class="card-box">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="angkatan"> Angkatan <span class="text-danger">*</span>
                                                        </label>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="gereja_id"> Jurusan <span class="text-danger">*</span>
                                                        </label>
