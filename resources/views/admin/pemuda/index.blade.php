                                ...
                                <div class="row mt-3 d-flex justify-content-between">
                                    ...
                                    <div class="">
                                        @if (!Auth::user()->hasRole('wilayah'))
                                            <a class="btn btn-dark" href="{{ route('admin.alumni.tambah') }}"> Tambah Data
                                                <i data-feather="plus"></i></a>
                                        @endif
                                        <a class="btn btn-success"
                                            href="{{ route('admin.pemuda.excel', 's=' . request()->s) }}">Cetak Excel <i
                                                data-feather="printer"></i></a>
                                        <a class="btn btn-danger"
                                            href="{{ route('admin.pemuda.pdf', 's=' . request()->s ?? '') }}">Cetak PDF <i
                                                data-feather="printer"></i></a>
                                    </div>
                                </div>
