            ...
            <div class="container-fluid">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            @if (session()->has('impersonate') and !Auth::user()->hasRole('admin'))
                                <a class="dropdown-item" href="{{ route('admin.impersonate.stop') }}"> <i
                                        class="fe-user"></i>
                                    {{ __('Admin') }}
                            @endif
                            </a>
                ...
                <div class="logo-box">
                    <a href="{{ url('/admin/dashboard') }}" class="logo logo-dark text-center">
                        <span class="logo-sm">
                            <label class="text-white">SI Alumni Teknik Uncen</label>

                        </span>
                        <span class="logo-lg">

                            <label class="h5 text-white fw-bolder">SI Alumni Teknik Uncen</label>
                        </span>
                    </a>
