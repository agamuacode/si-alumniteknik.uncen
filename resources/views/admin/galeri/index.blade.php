                                ...
                                <div class="row mt-3 d-flex justify-content-between">
                                    ...
                                    <div class="">
                                        @if (Auth::user()->hasRole('wilayah') || Auth::user()->hasRole('admin'))
                                            <a class="btn btn-dark" href="{{ route('admin.galeri.tambah') }}"> Tambah Data
                                                <i data-feather="plus"></i></a>
                                        @endif
                                        <a class="btn btn-success"
                                            href="{{ route('admin.galeri.excel', 's=' . request()->s) }}">Cetak Excel <i
                                                data-feather="printer"></i></a>
                                        <a class="btn btn-danger"
                                            href="{{ route('admin.galeri.pdf', 's=' . request()->s ?? '') }}">Cetak PDF <i
                                                data-feather="printer"></i></a>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-dark">
                                                    <img src="{{ asset($data->foto) }}" alt="Picture"
                                                        class="img img-fluid p-2 w-80 m-1 rounded" width="100">
                                                </td>
