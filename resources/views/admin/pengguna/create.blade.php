                                    ...
                                    <div class="col-12">
                                        <div class="card-box">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="wilayah_id"> Fakultas<span class="text-danger">*</span>
                                                        </label>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        @if ($errors->has('password'))
                                                            <span class="text-danger" role="alert">
                                                                <small class="pt-1 d-block"><i
                                                                        class="fe-alert-triangle mr-1"></i>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="password" name="password_confirmation"
                                                            id="password_confirmation" placeholder="" class="form-control">
