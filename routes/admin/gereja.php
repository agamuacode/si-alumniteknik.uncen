...
Route::group(['middleware' => ['role:admin|gereja|wilayah']], function () {
    ...
    Route::controller(GerejaController::class)->group(function () {
        Route::get('jurusan', [GerejaController::class, 'index'])->name('gereja');
        Route::get('jurusan/tambah', [GerejaController::class, 'create'])->name('jurusan.tambah')->middleware(['role:admin|gereja']);
        Route::get('jurusan/detail/{id}', [GerejaController::class, 'show'])->name('gereja.detail');
