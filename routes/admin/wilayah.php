...
Route::group(['middleware' => ['role:admin|gereja|wilayah']], function () {
    ...
    Route::controller(WilayahController::class)->group(function () {
        Route::get('fakultas', [WilayahController::class, 'index'])->name('wilayah');
        Route::get('fakultas/tambah', [WilayahController::class, 'create'])->name('fakultas.tambah')->middleware(['role:admin']);
        Route::get('fakultas/detail/{id}', [WilayahController::class, 'show'])->name('wilayah.detail');
